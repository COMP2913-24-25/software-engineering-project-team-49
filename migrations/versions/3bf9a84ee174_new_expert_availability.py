"""new expert_availability

Revision ID: 3bf9a84ee174
Revises: c99e71a99422
Create Date: 2025-03-13 11:15:19.020916
...
revision = '3bf9a84ee174'
down_revision = 'c99e71a99422'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('status', sa.Enum('AVAILABLE', 'UNAVAILABLE', name='availabilitystatus'), nullable=True),
